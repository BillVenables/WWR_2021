#' Convolutions
#'
#' Several codings for the convolution of two sequences
#' @name convolve
#' @aliases convolveR convolveJMC convolveFFT convolveSTATS
#' @param a an numeric vector
#' @param b a numeric vector
#' @export
#' @return A numeric vector providing the convolution
#' @examples
#' p <- pascal <- c(1,1)
#' for(i in 1:10) {
#'   cat(p, "\n")
#'   p <- convolveR(p, pascal)
#' }
#' rm(p, pascal)
